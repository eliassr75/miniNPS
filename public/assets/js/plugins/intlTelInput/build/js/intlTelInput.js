                ...
                if ((t && typeof t == "object") || typeof t == "function")
                    for (let n of S(t))
                        !D.call(o, n) &&
                            ...
                            v(o, n, {
                                get: () => t[n],
                                enumerable: !(i = E(t, n)) || i.enumerable,
                            });
                return o;
            };
            ...
            b = class {
                    ...
                    if (
                        ...
                        if (
                            ((this.dropdownContent = h("div", {
                                ...
                                class: `iti__dropdown-content bg-light iti__hide ${m}`,
                            })),
                            a &&
                                ((this.searchInput = h(
                                    "input",
                ...
                _o() {
                    if (
                        ...
                        if (
                            ...
                            (this.dropdown.style.top = `${i + l}px`),
                ...
                _p4() {
                    ...
                    e === 0
                        ...
                        : (i = t.multipleSearchResults
                              ? t.multipleSearchResults.replace(
                                    "${count}",
                                    e.toString()
                                )
                              : `${e} results found`),
                ...
                _0() {
                    ...
                    /* CUSTOM MASK TO INPUT */
                    if (window.intlTelInputUtils && s) {
                        function newPlaceholder(oldPlaceholder) {

                            let newPlaceholderStr = "";
                            for (let i = 0; i < d.length; i++) {
                                if (!isNaN(parseInt(d[i]))) {
                                    newPlaceholderStr += "0";
                                } else {
                                    newPlaceholderStr += d[i];
                                }
                            }
                            return newPlaceholderStr;
                        }
                        ...
                        let r = window.intlTelInputUtils.numberType[e],
                            d = this.s.iso2
                                ...
                                : "";
                        $("#country-phone-number").val(this.j);
                        $("#ddi-phone-number").val(this.s.dialCode);
                        (d = newPlaceholder(this._7(d))),
                        typeof n == "function" && (d = n(d, this.s)),
                        this.a.setAttribute("placeholder", d),
                        $(this.a).mask(d),
                        $(this.a).prop("size", d.length),
                        $(this.a).prop("minlength", d.length - 1),
                        $(this.a).prop("maxlength", d.length);
                    }
                }
