...
@section('content')
    ...
    <div class="section mt-4">
        ...
        <div class="transactions">
            ...
            <a href="app-transaction-detail.html" class="item">
                <div class="detail">
                    <img src="{{ asset('assets/img/sample/avatar/avatar3.jpg') }}" alt="img" class="image-block imaged w48">
                    <div>
            ...
            <a href="app-transaction-detail.html" class="item">
                <div class="detail">
                    <img src="{{ asset('assets/img/sample/avatar/avatar4.jpg') }}" alt="img" class="image-block imaged w48">
                    <div>
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar2.jpg') }}" alt="img" class="imaged w-100">
                    ...
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar3.jpg') }}" alt="img" class="imaged w-100">
                                <strong>Elwin</strong>
                            </div>
                        </a>
                    </li>
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar4.jpg') }}" alt="img" class="imaged w-100">
                                <strong>Alma</strong>
                            </div>
                        </a>
                    </li>
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar5.jpg') }}" alt="img" class="imaged w-100">
                    ...
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar6.jpg') }}" alt="img" class="imaged w-100">
                                <strong>Maria</strong>
                            </div>
                        </a>
                    </li>
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar7.jpg') }}" alt="img" class="imaged w-100">
                    ...
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar8.jpg') }}" alt="img" class="imaged w-100">
                    ...
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar9.jpg') }}" alt="img" class="imaged w-100">
                                <strong>Alex</strong>
                            </div>
                        </a>
                    </li>
                    <li class="splide__slide">
                        <a href="#">
                            <div class="user-card">
                                <img src="{{ asset('assets/img/sample/avatar/avatar10.jpg') }}" alt="img" class="imaged w-100">
                                <strong>Stina</strong>
                            </div>
                        </a>
                    </li>
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    ...
                    <li class="splide__slide">
                        <a href="app-blog-post.html">
                            <div class="blog-card">
                                <img src="{{ asset('assets/img/sample/photo/2.jpg') }}" alt="image" class="imaged w-100">
                                <div class="text">
                    ...
                    <li class="splide__slide">
                        <a href="app-blog-post.html">
                            <div class="blog-card">
                                <img src="{{ asset('assets/img/sample/photo/3.jpg') }}" alt="image" class="imaged w-100">
                                <div class="text">
                    ...
                    <li class="splide__slide">
                        <a href="app-blog-post.html">
                            <div class="blog-card">
                                <img src="{{ asset('assets/img/sample/photo/4.jpg') }}" alt="image" class="imaged w-100">
                                <div class="text">
